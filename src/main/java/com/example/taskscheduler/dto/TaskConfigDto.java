...
import com.example.taskscheduler.dto.workflow.WorkflowEdge; // Import the new enum
...
public class TaskConfigDto {
     ...
     * <ul>
     * <li>{@code 0}: Bean Task - Executes a method on a specified Spring
     * bean.</li>
     ...
     * <li>{@code 10}: Workflow Task - Orchestrates a series of other
     * tasks.</li>
     * </ul>
     */
     ...
     * <ul>
     * <li>For BEAN (0): JSON string representing parameters for the bean
     * method.</li>
     * <li>For HTTP (2): JSON string representing
     * {@link com.example.taskscheduler.dto.taskparams.HttpTaskParameters}.</li>
     * <li>For SHELL (4): JSON string representing
     * {@link com.example.taskscheduler.dto.taskparams.ShellTaskParameters}.</li>
     * <li>For WORKFLOW (10): Typically null or empty for the parent workflow
     * task itself, as parameters are usually defined within nodes or
     * globally.</li>
     * </ul>
     */
    ...
    /**
     * Defines how the task behaves in a cluster. Defaults to
     * {@link ExecutionMode#BROADCAST}.
     * <ul>
     * <li>{@link ExecutionMode#BROADCAST}: Task runs on all instances.</li>
     * <li>{@link ExecutionMode#CLUSTER}: Task attempts to acquire a distributed
     * lock to run on a single instance. The lock name is automatically derived
     * (e.g., `task_lock_id_{taskId}`).</li>
     * </ul>
     */
    ...
    // Advanced features
    /**
     * Calendar group name (e.g., "NATIONAL_HOLIDAYS") to check for non-working
     * days.
     */
    private String taskCalendarGroup;
    /**
     * Comma-separated time ranges for daily exclusion, e.g.,
     * "00:00-08:00,22:00-23:59".
     */
    ...
    /**
     * Comma-separated user IDs to notify on failed or timed-out task
     * completion.
     */
    ...
    /**
     * List of nodes defining the workflow structure. Only applicable if
     * taskType is WORKFLOW.
     */
    private List<WorkflowNode> workflowNodes;
    /**
     * List of edges defining transitions between workflow nodes. Only
     * applicable if taskType is WORKFLOW.
     */
    private List<WorkflowEdge> workflowEdges;
    /**
     * Global parameters for a workflow task, accessible within node parameter
     * templating. Only applicable if taskType is WORKFLOW.
     */
