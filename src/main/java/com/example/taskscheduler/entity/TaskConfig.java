...
public class TaskConfig {
     ...
     * 4: Shell script task (executes a shell script).
     * 10: Workflow task (orchestrates a series of other tasks).
     */
     ...
     * - Bean task (0): Parameters for the bean method.
     * - HTTP task (2): JSON of HttpTaskParameters (url, method, headers, body, timeouts).
     * - Shell task (4): JSON of ShellTaskParameters (script content/path, arguments, working dir).
     * - Workflow task (10): Not directly used by parent, but nodes have their own parameters.
     */
