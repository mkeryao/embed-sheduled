 ...
 * This replaces the default Jackson converter. It defines global serialization features
 * such as date formatting and handling of null values.
 */
@Configuration
public class FastjsonConfig implements WebMvcConfigurer {

    /**
     * Configures and registers the FastJsonHttpMessageConverter.
     * This converter will be used by Spring MVC for handling JSON request/response bodies.
     *
     ...
     * other converters (like a potentially still present Jackson if not fully excluded),
     * it's usually added at the beginning of the list or other converters are removed.
     * Spring Boot typically orders converters, and adding a custom one often gives it precedence.
     * If `spring-boot-starter-json` is excluded, this should become the primary JSON converter.
     */
    @Override
