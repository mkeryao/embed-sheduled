...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleGlobalException(Exception ex, WebRequest request) {
        ...
        // In a production environment, you might not want to expose ex.getMessage() directly to the client
    ...
    // Example: To handle exceptions from your custom services if they throw specific types
    // @ExceptionHandler(WorkflowExecutionException.class)
    // @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    // public ResponseEntity<Map<String, String>> handleWorkflowException(WorkflowExecutionException ex, WebRequest request) {
    //     logger.error("Workflow execution error: {}", ex.getMessage(), ex);
    //     Map<String, String> errorResponse = new HashMap<>();
    //     errorResponse.put("status", "error");
    //     errorResponse.put("message", "Workflow processing failed: " + ex.getMessage());
    //     return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
    // }
}
