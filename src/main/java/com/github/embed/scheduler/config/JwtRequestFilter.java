...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer")) {
            ...
            logger.warn("Authorization header does not begin with Bearer String or is missing for path: {}",
                    requestURI);
        }
        ...
        if (username != null && jwtUtil.validateToken(jwt, username)) { // Validating against the extracted username
            ...
            // In a Spring Security setup, this is where SecurityContextHolder would be
            // updated.
